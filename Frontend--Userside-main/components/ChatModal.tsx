...
interface ChatModalProps {
    ...
    stopListening: () => void;
    currentLang: 'en-IN' | 'hi-IN' | 'ta-IN';
    setLang: (lang: 'en-IN' | 'hi-IN' | 'ta-IN') => void;
}
            ...
            <div className="bg-orange-50 dark:bg-gray-800 w-full max-w-lg h-[80vh] rounded-t-2xl flex flex-col">
                ...
                <div className="p-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                    ...
                    <div className="flex items-center space-x-2 mt-2 justify-center">
                        ...
                        <button onClick={() => setLang('ta-IN')} className={`px-2 py-0.5 text-xs rounded-full ${currentLang === 'ta-IN' ? 'bg-orange-500 text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-500 dark:text-gray-300'}`}>தமிழ்</button>
                    </div>
                </div>
            </div>
        </div>
