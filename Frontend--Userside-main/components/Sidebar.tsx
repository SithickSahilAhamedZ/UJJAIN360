...
const SidebarContent = ({ activePage, setActivePage, onLinkClick, userRole, onLogout }: SidebarContentProps) => {
  ...
  return (
    <div className="h-full bg-white dark:bg-gray-800 flex flex-col p-4">
      <div className="flex items-center justify-between mb-6 h-12 flex-shrink-0">
          <div className="flex items-center space-x-2">
            <Bot size={32} className="text-orange-500"/>
            <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Ujjain360</h1>
          </div>
      </div>
      <nav className="flex-grow overflow-y-auto space-y-2 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-transparent">
      ...
      <div className="mt-auto space-y-4 flex-shrink-0 pt-4">
        <button
